...
Integrate workforce, performance, and revenue data into a single analytical system
...
Which department generates the highest revenue per employee?

Which departments have high costs but low performance?

How does employee performance relate to salary levels?

Are there signs of overstaffing or inefficiency in certain departments?
...
├── notebooks/   # Python data cleaning and transformation
...
Workforce overview (headcount, average salary, department size)
...
Designing a normalised relational database for analytics

Writing SQL queries to support business decision-making
